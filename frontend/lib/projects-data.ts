...
export const projects: Project[] = [
  ...
  },
  {
    ...
    detailedDescription:
      "A dynamic food ordering platform featuring interactive restaurant listings, real-time cart management, and a smooth checkout flow. Deployed on GitHub Pages with an intuitive, mobile-responsive UI to increase usability across devices.",
    image: "/food.jpg",
    ...
    learningOutcomes: [
      "Building responsive layouts for varying screens without desktop compromise",
      "Handling global cart state on the client side",
      "Optimizing image loading and component rendering"
    ],
    links: {
      github: "https://github.com/Adityakumarsahoo",
    },
  ...
  },
  {
    ...
    detailedDescription:
      "A full-stack e-commerce application with product browsing, cart management, order processing, and JWT-secured user authentication. Designed with a highly responsive UI using Tailwind CSS to achieve consistent performance across desktop and mobile browsers.",
    image: "/invoice.jpg",
    ...
    learningOutcomes: [
      "Securing api routes using JSON Web Tokens (JWT) middleware",
      "Designing responsive grids and animations with Tailwind CSS",
      "Managing complex state for product catalogs and user sessions"
    ],
    links: {
      github: "https://github.com/Adityakumarsahoo",
    },
  ...
  },
  {
    ...
    detailedDescription:
      "A real-time SEO tracking dashboard enabling users to monitor keyword rankings, track position changes, and visualize search engine performance metrics. Integrates SEO analytics APIs and features clean data visualizations to surface actionable insights for improving website search visibility.",
    image: "/lms.jpg",
    ...
    features: [
      "Real-time keyword ranking monitor",
      "Search engine performance metrics tracking",
      "Clean data visualizations",
      "Actionable insights reporting"
    ],
    learningOutcomes: [
      "Integrating third-party SEO analytics APIs securely",
      "Implementing charts and graphs in React for big data visualizations",
      "Creating highly responsive dashboard layouts"
    ],
    links: {
      github: "https://github.com/Adityakumarsahoo",
    },
