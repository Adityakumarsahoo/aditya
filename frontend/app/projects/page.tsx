...
export default function ProjectsPage() {
  ...
  useEffect(() => {
    fetch(`${API_BASE_URL}/api/portfolio`)
      ...
      .catch((err) => console.log("Failed to load dynamic projects list", err));
  }, []);
      ...
      <div className={s.innerContainer}>
        ...
        <div className={s.projectsGrid}>
          {projectsList.map((project) => (
            <FollowerPointerCard
              key={project.slug}
              title={<TitleComponent title={project.author} avatar={project.authorAvatar} />}
            >
              <CometCard rotateDepth={10} translateDepth={12} className="h-full">
