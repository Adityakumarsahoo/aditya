...
export const homePageStyles = {
  ...
  // Callout card
  calloutCard: {
    wrapper: "w-full sm:w-auto sm:max-w-md md:max-w-lg lg:max-w-xl rounded-2xl p-3.5 bg-zinc-900/30 border border-zinc-800/40 backdrop-blur-md transition-all duration-300 hover:border-blue-500/25 hover:bg-zinc-900/50 hover:shadow-[0_0_20px_rgba(59,130,246,0.03)]",
    ...
    button: "mt-2 sm:mt-0 px-4 py-1.5 rounded-full border border-blue-500/20 bg-blue-950/20 text-blue-400 text-xs font-semibold shrink-0 transition-all duration-300 hover:bg-blue-400 hover:text-zinc-950 hover:border-blue-400 hover:shadow-[0_0_15px_rgba(59,130,246,0.2)] focus:outline-none"
  },
  ...
  // Article/Video card
  article: {
    wrapper: "rounded-2xl border border-zinc-900 bg-zinc-950/20 backdrop-blur-md shadow-2xl overflow-hidden w-full max-w-[880px] transition-all duration-500 hover:border-blue-500/15 hover:bg-zinc-950/40 hover:shadow-[0_0_40px_rgba(59,130,246,0.03)]",
    ...
    content: "p-6 md:p-8",
    header: "flex items-center gap-2 text-xs font-bold text-blue-400 uppercase mb-3 tracking-widest",
    ...
    linkContainer: "mt-6",
    link: "inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-zinc-400 hover:text-blue-400 transition-colors group/link",
...
export const timelineStyles = {
  ...
  // Badge styles
  timelineBadge: "inline-flex items-center rounded-full border border-blue-500/30 bg-blue-950/20 px-3.5 py-1 shadow-[0_2px_8px_rgba(59,130,246,0.06)]",
  timelineBadgeText: "text-xs font-bold uppercase tracking-wider text-blue-400 drop-shadow-[0_0_4px_rgba(59,130,246,0.15)]",
  ...
  itemContainer: "space-y-4 rounded-2xl border border-zinc-900 bg-zinc-900/10 backdrop-blur-md p-6 shadow-xl transition-all duration-350 hover:border-blue-500/30 hover:bg-zinc-900/30 hover:shadow-[0_0_30px_rgba(59,130,246,0.05)] hover:scale-[1.01]",
  ...
  iconContainerGreen: "rounded-xl bg-blue-500/10 p-2.5 border border-blue-500/20 flex items-center justify-center",
  ...
  iconContainerEmerald: "rounded-xl bg-blue-500/10 p-2.5 border border-blue-500/20 flex items-center justify-center",

  // Icon styles
  iconSize: "h-5 w-5",
  iconBlue: "h-5 w-5 text-blue-400",
  iconPurple: "h-5 w-5 text-purple-400",
  iconGreen: "h-5 w-5 text-blue-400",
  iconAmber: "h-5 w-5 text-amber-400",
  iconRose: "h-5 w-5 text-rose-400",
  iconEmerald: "h-5 w-5 text-blue-400",
  ...
  bulletGreen: "mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-blue-500",
  ...
  techBadge: "rounded-full bg-zinc-950/60 border border-zinc-900/60 px-3 py-1.5 text-xs text-zinc-450 transition-all duration-250 hover:border-blue-500/40 hover:text-blue-400 hover:bg-blue-950/25 hover:scale-105 hover:shadow-[0_0_12px_rgba(59,130,246,0.15)] shadow-sm",
  ...
  achievementCardTitle: "text-sm font-semibold text-blue-400",
  ...
  specializationTitle: "text-sm font-semibold text-blue-400",
  specializationBadgesContainer: "mt-2 flex flex-wrap gap-2",
  specializationBadge: "rounded-full bg-blue-900/30 px-3 py-1 text-xs text-blue-300",

  // Technologies section styles
  techSectionContainer: "mt-16 rounded-2xl border border-zinc-900 bg-zinc-900/10 backdrop-blur-md p-6 md:p-8 shadow-2xl relative overflow-hidden transition-all duration-350 hover:border-blue-500/20 hover:shadow-[0_0_35px_rgba(59,130,246,0.03)]",
  ...
  techCard: "group/tech relative flex flex-col justify-start rounded-xl border border-zinc-900 bg-zinc-950/20 p-5 text-center transition-all duration-350 hover:-translate-y-1 hover:bg-zinc-950/40 hover:border-blue-500/25 hover:shadow-[0_0_25px_rgba(59,130,246,0.05)]",
...
export const aboutPageStyles = {
  ...
  // Interests/Tags
  interestsContainer: "mt-4 flex flex-wrap gap-x-3 gap-y-2 text-xs font-semibold uppercase tracking-wider text-blue-400/80",
  interestItem: "flex items-center",
  interestSeparator: "ml-3 text-zinc-800 font-bold",

  // Tech Stack
  techStackContainer: "mt-8 flex flex-wrap gap-2.5",
  techPill: "rounded-full border border-zinc-850 bg-zinc-900/40 px-3.5 py-1.5 text-xs text-zinc-350 transition-all duration-300 hover:border-blue-500/40 hover:bg-blue-955/25 hover:scale-105 hover:text-blue-400 shadow-[0_2px_8px_rgba(0,0,0,0.3)] hover:shadow-[0_0_12px_rgba(59,130,246,0.15)]",

  // Content sections
  sectionsContainer: "mt-12 space-y-4",
  sectionCard: "relative overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-950/15 p-6 transition-all duration-350 hover:border-blue-500/25 hover:bg-zinc-950/35 hover:shadow-lg hover:shadow-blue-500/[0.005] hover:scale-[1.005]",
  ...
  primaryButton: "group relative rounded-xl bg-gradient-to-r from-blue-500 to-[#00E5FF] px-6 py-3.5 text-sm font-bold text-zinc-955 transition-all duration-300 hover:brightness-110 hover:shadow-lg hover:shadow-blue-500/30 active:scale-[0.98] inline-block text-center cursor-pointer hover:shadow-[0_0_25px_rgba(59,130,246,0.4)]",
...
export const contactPageStyles = {
  ...
  // Contact method card
  contactCard: "group flex items-center gap-4 rounded-xl border border-zinc-900 bg-zinc-900/10 p-4 transition-all duration-300 hover:border-blue-500/30 hover:bg-zinc-900/30 hover:shadow-lg hover:shadow-blue-500/[0.02] hover:scale-[1.01]",
  contactIconContainer: "flex h-12 w-12 items-center justify-center rounded-xl bg-zinc-950/80 border border-zinc-800 text-zinc-400 transition-all duration-300 group-hover:bg-blue-500/10 group-hover:border-blue-500/30 group-hover:text-blue-400 group-hover:shadow-[0_0_10px_rgba(59,130,246,0.1)]",
  contactIcon: "h-5 w-5",
  ...
  formInput: "peer w-full rounded-xl border border-zinc-850 bg-zinc-950/30 px-4 py-4 text-zinc-100 outline-none transition-all duration-300 placeholder:text-transparent focus:border-blue-500/60 focus:bg-zinc-900/10 focus:ring-1 focus:ring-blue-500/25 focus:shadow-[0_0_20px_rgba(59,130,246,0.07)]",
  formTextarea: "peer w-full resize-none rounded-xl border border-zinc-850 bg-zinc-950/30 px-4 py-4 text-zinc-100 outline-none transition-all duration-300 placeholder:text-transparent focus:border-blue-500/60 focus:bg-zinc-900/10 focus:ring-1 focus:ring-blue-500/25 focus:shadow-[0_0_20px_rgba(59,130,246,0.07)]",

  // Form label styles
  formLabelBase: "absolute pointer-events-none transition-all duration-200",
  formLabelFocused: "-top-2.5 left-3 text-[10px] font-bold text-blue-400 bg-zinc-950 border border-zinc-900 px-2 py-0.5 rounded-md uppercase tracking-wider scale-95",
  formLabelUnfocused: "top-4 left-4 text-sm font-medium text-zinc-500",

  // Submit button
  submitButtonContainer: "pt-4",
  submitButton: "group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-blue-500 to-[#00E5FF] px-8 py-4 text-sm font-bold text-zinc-950 transition-all duration-300 hover:brightness-110 hover:shadow-lg hover:shadow-blue-500/30 active:scale-[0.98] md:w-auto cursor-pointer disabled:opacity-50 hover:shadow-[0_0_25px_rgba(59,130,246,0.35)]",
...
export const projectStyles = {
  ...
  // Project card
  projectCard: "group relative h-full overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-950/20 transition-all duration-350 hover:border-blue-500/20 hover:bg-zinc-950/45 hover:shadow-[0_0_40px_rgba(59,130,246,0.04)] hover:scale-[1.015] cursor-pointer",
  ...
  tag: "rounded-md bg-zinc-900 px-2.5 py-1 text-xs font-semibold text-zinc-400 transition-colors hover:border-blue-500/20 hover:text-blue-400 hover:bg-zinc-900/30 border border-zinc-900/80",
  ...
  otherButton: "rounded-lg border border-zinc-800 bg-zinc-900 px-4 py-2 text-xs font-semibold text-zinc-300 transition-all duration-200 hover:border-blue-500/30 hover:bg-blue-950/10 hover:text-blue-400 hover:scale-105 cursor-pointer",
...
export const toolsPageStyles = {
  ...
  // Tool card
  toolCardLink: "group flex w-full cursor-pointer items-center gap-4 rounded-2xl p-4 border border-zinc-900 bg-zinc-900/10 backdrop-blur-md transition-all duration-350 hover:border-blue-500/35 hover:bg-zinc-900/25 hover:shadow-[0_0_30px_rgba(0,229,255,0.06)] hover:scale-[1.015]",
  toolIconContainer: "relative h-12 w-12 flex-shrink-0 rounded-xl overflow-hidden border border-zinc-850 bg-zinc-950/80 p-2 flex items-center justify-center transition-all duration-300 group-hover:border-blue-500/30 group-hover:scale-[1.05] group-hover:shadow-[0_0_12px_rgba(59,130,246,0.15)] shadow-inner backdrop-blur-sm",
  ...
  toolCategory: "text-xs font-semibold text-zinc-500 uppercase tracking-wider transition-colors duration-200 group-hover:text-blue-400"
};
...
export const sidebarStyles = {
  ...
  desktopAvatar: "w-12 h-12 rounded-full overflow-hidden ring-2 ring-zinc-900 transition-all duration-300 hover:ring-blue-400 hover:scale-[1.03] hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] shadow-md",
  ...
  navItemActive: "bg-blue-500/5 border-blue-500/20 border-l-2 border-l-blue-400 text-blue-400 font-semibold shadow-[0_0_25px_rgba(59,130,246,0.12)] border-r border-r-blue-500/5",
  navItemInactive: "text-zinc-400 hover:bg-zinc-900/40 hover:text-zinc-200 hover:border-zinc-850/45 hover:translate-x-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.03)] hover:border-blue-500/10",
  ...
  socialItem: "group flex items-center gap-3 px-3 py-2 rounded-xl text-zinc-400 hover:text-blue-400 hover:bg-zinc-900/30 hover:translate-x-0.5 border border-transparent transition-all duration-300",
  ...
  mobileSocialItem: "group flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-zinc-450 hover:text-blue-400 hover:bg-zinc-900/20 border border-transparent transition-all duration-300",
  ...
  bottomNavLinkActive: "text-blue-400 bg-blue-500/5 border-blue-500/20 shadow-[0_0_12px_rgba(59,130,246,0.05)]",
